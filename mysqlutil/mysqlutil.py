...
def make_sql_condition_in_range(fields, start, end=None, operator="=", formatter=list):
...
def make_mysqldump_in_range(fields, conn, db, table, path_dump_to, dump_exec, start, end=None):
